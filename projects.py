projects = [
  ...
  },
  {
    ...
    "name": "Sticky Notes",
    "techs": ["react", "css", "html", "netlify"],
    "description": "Eco-friendly React application that saves time and trees. The app utilizes local storage to save the notes even when the browser has been closed.",
